      ...
      >
        ...
        <g transform={`translate(${xfm.x},${xfm.y}) scale(${xfm.s})`}>
          ...
          {edges.map((edge, i) => {
            ...
            const color = strong ? C.amber : "#2d4263";
                  ...
                  return (
                    <div key={i} style={{
                      ...
                      <span style={{
                        ...
                        background: strong ? "#f59e0b18" : "#22d3ee14",
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 7 }}>
                {selIssues.map((issue, i) => (
                  <div key={i} style={{
                    ...
                    <div style={{ fontSize: 9, color: "#f87171", fontWeight: 700, letterSpacing: "0.08em", marginBottom: 5 }}>
